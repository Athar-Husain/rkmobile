...
// import { BarcodeScanner } from 'expo-barcode-scanner' // or any camera library
...
const StaffPOSScreen = ({ route, navigation }) => {
    ...
    const storeId = route.params?.storeId || 'STORE_DEFAULT' // multi-store
    ...
    // Cancel purchase - clear cart & preview
    ...
    const handleBarCodeScanned = ({ data }) => {
        // You can fetch item details via API using `data` (barcode)
        ...
        >
            ...
            <Modal visible={barcodeModal} animationType="slide">
                <View style={{ flex: 1 }}>
                    ...
                    /> */}
                    <TouchableOpacity
                        style={[styles.completeBtn, { margin: 20 }]}
