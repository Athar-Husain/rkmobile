...
const StaffPOSScreen = ({ route, navigation }) => {
    ...
    // Complete Purchase with confirmation dialog
    const completePurchase = () => {
        ...
        Alert.alert(
            'Confirm Purchase',
            `Are you sure you want to complete this purchase? Total: ₹${
                staffPOSSummary?.finalAmount || 0
            }`,
            [
                    ...
                    onPress: async () => {
                        try {
                            ...
                            if (res.meta.requestStatus === 'fulfilled') {
                                ...
                                Alert.alert(
                                    'Error',
                                    res.payload?.message || 'Purchase failed'
                                )
                            }
                        } catch (error) {
