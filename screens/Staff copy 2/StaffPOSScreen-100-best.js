...
const StaffPOSScreen = ({ route }) => {
    ...
    const completePurchase = async () => {
        ...
        try {
            ...
            Alert.alert(
                'Error',
                'Something went wrong while completing purchase'
            )
        }
    }
                    ...
                    <View style={styles.modalBackground}>
                        ...
                        >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={closeReceipt} // ✅ reset cart & summary
                            >
...
const styles = StyleSheet.create({
    ...
    btnText: { color: '#fff', fontSize: scale(16), fontWeight: '600' },
    cartRow: {
        flexDirection: 'row',
    ...
    cartItem: { fontSize: scale(14), fontWeight: '500' },
    subText: { fontSize: scale(12), color: '#555', marginLeft: scale(8) },
    removeText: { color: 'red', fontSize: scale(13) },
    qtyBtn: {
        borderWidth: 1,
        borderColor: '#888',
        borderRadius: 4,
    ...
    qtyText: { fontSize: scale(14), fontWeight: '600' },
    summary: {
        marginTop: scale(20),
        padding: scale(16),
