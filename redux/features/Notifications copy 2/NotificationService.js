...
const NotificationService = {
    ...
    read: () => axiosInstance.get('/read').then((res) => res.data),
    ...
    read: (id) => axiosInstance.post(`/read/${id}`).then((res) => res.data),

    // STAFF
    read: (data) => axiosInstance.post('/read', data).then((res) => res.data),
